...
public class CoolAutoCommand extends CommandBase {
    public final DrivetrainSubsystem m_drivetrainSubsystem;
    public final ArmSubsystem m_armSubsystem;

    public CoolAutoCommand(DrivetrainSubsystem drivetrainSubsystem, ArmSubsystem armSubsystem) {
        ...
        andThen(new AutoDriveToTarget(m_drivetrainSubsystem, new Pose2d(new Translation2d(0.0, 3.8), new Rotation2d(180)))); 
    }
